...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand" to="/">LawAbiders</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink exact activeClassName="selected" className="nav-link" to="/products">Service Edit</NavLink>
        </li>
        <li className="nav-item">
          <NavLink exact activeClassName="selected" className="nav-link" to="/about">About</NavLink>
        </li>
        <li className="nav-item">
